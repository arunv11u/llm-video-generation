        ...
        with gr.Row():
            with gr.Column():
                ...
                sv_prompt = gr.Textbox(
                    ...
                    lines=6,
                    info="Wan 2.2: one line per chunk (5s each), last line repeats. SkyReels V2: all lines merged into one continuous generation.",
                )
                sv_music = gr.Audio(
                    label="Background Music (optional)",
                    type="filepath",
